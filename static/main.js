...
//search-hint
document.querySelector('.search-field').onkeyup = function(){
    let input = document.querySelector('.search-field').value;
...
function hint_display(value){
    ...
    block.onclick = function(){
        document.querySelector('.search-field').value = block.innerHTML;
        hint_clear();
    }
}
//hint-clear
